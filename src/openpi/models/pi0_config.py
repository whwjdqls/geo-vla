...
class Pi0Config(_model.BaseModelConfig):
    ...
    # this is for auxiliary experts that will be only used during training
    aux_expert_type: str = "none"  # options: "none", "point", "depth"
    point_expert_variant: _gemma.Variant | None = "point_head_v1"
    ...
    # Optional training-only auxiliary loss for the PyTorch model. Default 0 disables it.
